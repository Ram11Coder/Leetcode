...
public class Reverse {
	public static void main(String[] args) throws NoSuchAlgorithmException {
		...
		/*
		 * System.out.println(reverse(1234)); System.out.println(reverse(-123));
		 * System.out.println(reverse(-8)); System.out.println(reverse(1231342234));
		 * System.out.println(reverse(999999991));
		 * System.out.println(reverse(-1231342238));
		 * System.out.println(reverse(124000000)); System.out.println(reverse(555555));
